...
def __init__():
    global kmeans, model, explainer, weather_API, cluster_num, cluster_centers, train_columns, test_data
    ...
    cluster_num = int(config['PREDICT']['cluster_num'])
    train_columns = eval(config['PREDICT']['train_columns'])
    weather_API = config['PREDICT']['weather_API']
